---
title: "Case study — Hochschule für Musik Trossingen"
slug: case-study-hochschule-trossingen
section: education
summary: "How Germany's Hochschule für Musik Trossingen integrates Playtronica into its music-technology and MIDI research programs. Two orders, €1,580, faculty + lecturer use."
segment: ["education", "b2b", "international"]
deflection_target: 0
order: 22
status: new-2026-05
...
The lecturer of record is Tobias Rotsch, with the procurement-friendly support account at `support-midir@mh-trossingen.de` handling the orders. "MIDI Research" is right there in the support account name — these devices are being used as research instruments, not as toys.
