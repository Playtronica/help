...
**The equity bucket.** Traditional music education is biased toward students whose families could buy an instrument and pay for lessons. Music technology in the classroom levels that. A student who arrives in your room with no prior music experience can produce a finished piece by the end of the period. We've seen this in Lincoln Center's family-day programs (see our [Lincoln Center case study](/education/case-study-lincoln-center/)) and in Stanford's d.school workshops (see our [Stanford case study](/education/case-study-stanford-dschool/)). The first-touch sound is the equity moment.
...
## 2. What "music technology in the classroom" actually means
...
**Standards anchors:** NCAS MU:Cn10.1.K-2 (relating music to personal experience) — touching an object you brought from home and hearing it sing is literally that. Our [Lesson 1 (Touch as Conductor)](/education/lesson-1-touch-as-conductor/) is the K-2 entry point.
...
**Standards anchors:** NCAS MU:Cr2 (organising and developing musical ideas), NGSS 4-PS3 (energy transfer — fruit-as-circuit is literal energy transfer). Our [Lesson 2 (Music from the Orchard)](/education/lesson-2-fruit-orchard/) is the canonical 3-5 lesson.
...
**Standards anchors:** NCAS MU:Cr1.1.7 (generating musical ideas), MU:Cr2.1.7 (organising), UK MMC KS3 Compose, ISTE 1.4 (innovative designer). Our [Lesson 4 (Pattern, Pulse, Sequence)](/education/lesson-4-pattern-pulse-orbita/) is the middle school entry.
...
**Specific high-school pattern:** the **accessibility design challenge**. Students design a piece playable by a partner who cannot use a traditional keyboard. This is real composition practice (constraint drives creativity), serious music theory (you have to understand what notes work without keys), and meaningful empathy. Our [Lesson 5 (Composing for the Body)](/education/lesson-5-composing-for-the-body/) is built around this exact challenge.
...
This is what Hochschule für Musik Trossingen does with our hardware — see the [case study](/education/case-study-hochschule-trossingen/). Stanford's d.school took a different angle (design-thinking framing — see [their case study](/education/case-study-stanford-dschool/)). Both work. The common thread: the device must be **technically deep enough** to reward a serious user.

---

## 4. Standards alignment — the four documents that matter
...
**Buy:** custom mix. Talk to us. Bigger orders include on-site training, white-glove setup, and custom curriculum updates. The [Lincoln Center](/education/case-study-lincoln-center/) configuration was incremental — three orders over two years; that's the wise pattern.
...
## 6. Lesson design for music tech — the 4-phase template
...
## 7. Classroom management for music-tech lessons
...
## 8. Special education and accessibility
...
Our [Lesson 5 (Composing for the Body)](/education/lesson-5-composing-for-the-body/) is built around accessibility design. The same lesson works in mainstream and in SPED settings; the body-aware framing benefits everyone.
...
## 9. Procurement and budget — where the money comes from
...
For a procurement-ready conversation, the fastest path is our [institutional quote form](/education/quote/). We reply within 1 business day with a quote PDF and any supporting documents your finance office needs.
...
We're a small team based in Tallinn, Estonia. Founded by Sasha Pas in 2014. Our devices are used by Lincoln Center, Stanford d.school, Berklee College of Music, Hochschule für Musik Trossingen, Centre Pompidou, Garage Museum, Filharmonia Opolska, Singapore Ministry of Education, and many others. Our pricing for institutional buyers is on the [pricing page](/education/#pricing); pilot applications are open at the [pilot page](/education/pilot/).
...
- **[Lesson 1 PDF download](/education/playtronica-lesson-1.pdf)** — print-ready K-2 lesson on touch and conductivity. Teach it tomorrow with no Playtronica devices — bring fruit, foil, and a multimeter to demonstrate the concept of conduction. Then upgrade to TouchMe if it lands.
- **[Standards alignment map](/education/standards/)** — lesson-by-lesson NCAS / UK MMC / NGSS / ISTE citations. Useful for curriculum review boards.
- **[5 free lessons in full](/education/curriculum/)** — Lessons 1-5 from our 15-lesson curriculum. Free, CC-BY-4.0 licensed. Use them as-is, modify them, take them to your colleagues.
- **[Free pilot program](/education/pilot/)** — applications open for Fall 2026 cohort. 5 schools selected; each receives a free Class Pack 10 (€1,380 value). In return: a written case study + photo/video rights. Applications close 31 August 2026.
- **Talk to Andrey** — founder of Playtronica reads every email. [manirko@playtronica.com](mailto:manirko@playtronica.com). Reply within 1 business day. No sales pitch unless you ask for one.

---

## Related guides + reading

- **Lesson 1 — [What is sound? Touch as conductor](/education/lesson-1-touch-as-conductor/)** — the canonical K-2 entry point.
- **Lesson 5 — [Composing for the body](/education/lesson-5-composing-for-the-body/)** — the accessibility-design lesson.
- **Lincoln Center case study — [Performing Arts institution in NYC](/education/case-study-lincoln-center/)** — three repeat orders, multi-program use.
- **Stanford d.school case study — [Design-thinking + maker pedagogy](/education/case-study-stanford-dschool/)** — €1,802 mixed-device order.
- **Hochschule für Musik Trossingen case study — [European conservatory + MIDI research](/education/case-study-hochschule-trossingen/)** — single-faculty-led adoption.
- **[Standards alignment](/education/standards/)** — lesson-by-lesson mapping.
- **[Pricing tiers](/education/#pricing)** — Single Teacher Starter through District / Lab.
- **[Institutional quote](/education/quote/)** — POs accepted, 1-business-day reply.
...
If you find a factual error in this guide, email [manirko@playtronica.com](mailto:manirko@playtronica.com) and we'll fix it. If you teach a music-tech lesson that works really well and isn't in our curriculum, send it — we credit teachers and license under CC-BY-4.0. The goal here is to make music education better. The guide is one tool toward that goal. Your classroom is another. Use both.
