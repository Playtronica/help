---
title: "Lesson 5 — Composing for the body"
slug: lesson-5-composing-for-the-body
section: education
summary: "Grades 6-12. Accessibility-focused lesson: students design a piece playable by a partner who cannot use a traditional keyboard. 45 minutes."
segment: ["education"]
deflection_target: 0
order: 5
status: new-2026-05
...
- **Teacher prep (10 min):** Pre-attach patches to TouchMe for each pair to save class time. Confirm headphones work at every station. Read the [accessibility brief](#further-reading) section before class to anchor the discussion.
...
- "Designing for the body" — see also our [accessibility-focused devices](/devices/compare/) for which Playtronica device best matches each constraint.
