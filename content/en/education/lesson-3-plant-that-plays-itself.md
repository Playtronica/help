---
title: "Lesson 3 — The plant that plays itself"
slug: lesson-3-plant-that-plays-itself
section: education
summary: "Grades 3-8. Cross-curricular biology + music. Students set up Biotron on a classroom houseplant and observe how living signals become MIDI. 60-minute lesson."
segment: ["education"]
deflection_target: 0
order: 3
status: new-2026-05
...
1. Set up Biotron on a houseplant and trigger sound by touching or moving near the plant.
2. Identify three variables that change the plant's signal (touch, light, water, proximity).
3. Record at least one minute of plant audio and reflect on what changed when they intervened.
