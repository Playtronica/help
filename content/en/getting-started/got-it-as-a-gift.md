...
Welcome. You can make music from a banana, a houseplant, or your friend's hand. This page is the fastest path.

First, identify your device. All five are bare circuit boards:

- 👐 **TouchMe** — small board with two gold pads. You touch the pads.
- 🍉 **Playtron** — larger board with alligator clips. You clip the wires to objects and touch the objects.
- 🌿 **Biotron** — black box with cables that clip to plant leaves. The plant plays the music.
- 🌀 **Orbita** — round device with a motor. It plays itself.
- ⚖️ **Scales** — board with a weight plate. Heavier objects play higher notes.

If you cannot identify your device, see [Which Playtronica do I have?](/getting-started/which-device/). Each device page opens with a photo.
...
That is fine. Four options to consider first:

- **Try it once with another person.** Many of the best moments happen when a second person holds the other end of the circuit. Invite a friend, a child, a flatmate.
- **Pass it on.** A music teacher, an artist, a curious child, a nephew or niece — many people would value this device.
