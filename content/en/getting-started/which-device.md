---
title: "Which Playtronica do I have?"
slug: which-device
...
[👐 TouchMe — complete guide](/devices/touchme/) · [deep dive](/devices/touchme-advanced/)
...
- **In the box:** TouchMe and a USB-C cable.
...
- **In the box:** Playtron, a USB-C cable, and alligator-clip cables.
...
- **In the box:** Biotron, a USB-C cable, and two leaf-pad probes on cables.
...
[🌀 Orbita — rotating MIDI sequencer](/devices/orbita/) · [deep dive](/devices/orbita-advanced/)
...
- **In the box:** Orbita, a USB-C cable, and coloured magnets.
...
[⚖️ Scales — the weight-to-MIDI instrument](/devices/scales/)
...
- **In the box:** Scales and a USB-C cable.
