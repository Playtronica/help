---
title: "What objects can you play?"
slug: objects-you-can-play
section: sound
...
- **Another person's skin** — the signature two-person demo. Each person holds one pad and touches the other person. The touch between them plays the music. See [TouchMe](/devices/touchme/) for the full demo.
...
**Strong picks:** monstera, rubber plant (Ficus elastica), pothos, philodendron, snake plant.
**Weaker picks:** succulents, cacti, aloe vera (work but produce sparser music).
**Avoid:** grass, dried plants, very small plants, cut flowers in water.

See [Biotron](/devices/biotron/) for the full plant-selection guide and the experiment that helps you find the most musical plant in your room.
...
- **Improve your ground.** A weak ground reduces the signal. See [Grounding — how and why](/sound/grounding/).
...
**[Bare Conductive Electric Paint](https://www.adafruit.com/product/1305)** — water-based, non-toxic, dries at room temperature. Paint a keyboard on paper, paint shapes on cardboard, paint sensors onto walls. Each painted shape becomes a Playtron note when you clip to it. The 10 mL paint pen is the easiest way to start.
...
**[Knit conductive fabric](https://www.adafruit.com/product/1167)** — less than 1 Ω per foot of resistance. Cut it into shapes, sew them onto a garment, clip Playtron to the shape. Touching the fabric closes a circuit through your body.
...
Cheap and reliable. The Playtronica shop sells [copper tape](https://shop.playtronica.com/collections/additional-items) directly. Stick it onto a piece of paper, a cardboard cutout, a 3D print — any shape is a key.

### Bare Conductive Touch Board (different category)

The [Bare Conductive Touch Board](https://www.adafruit.com/product/2216) is a standalone alternative-conductivity device that pairs naturally with Playtronica thinking. We mention it because curious customers often ask. It plays its own samples from an SD card rather than sending MIDI; not a replacement for Playtron, but a sibling in the same world.
